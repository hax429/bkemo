...
export interface MentionDropdownCallbacks {
  ...
  onAttachVaultReference?: (path: string, kind: 'file' | 'folder') => void;
  ...
  private selectMentionItem(): void {
    ...
    switch (selectedItem.type) {
      ...
      case 'folder': {
        ...
        this.callbacks.onAttachVaultReference?.(normalizedPath ?? selectedItem.path, 'folder');
      ...
      default: {
        ...
        if (normalizedPath) {
          ...
          this.callbacks.onAttachVaultReference?.(normalizedPath, 'file');
        }
